...
<section class="parallax section section-text-light section-parallax section-center" data-stellar-background-ratio="0.5" style="background-image: url(<?php if (render($content['field_image'])) { echo file_create_url($node->field_image['und'][0]['uri']); } ?>);">
	<div class="container">
			...
			<div class="span12">
			  ...
			  <?php if (render($content['field_parallax_icon'])) :?>
				...
				<?php if (render($content['field_big_caption'])) :?>
				  <h2 class="mb-none <?php print render($content['field_text_color']); ?>"><strong><?php print render($content['field_big_caption']); ?></strong></h1>
				<?php endif; ?>
