    ...
    var styleSwitcher = {
        ...
        initialize: function() {
            ...
            if (!this.initialized) {
                if ($("html").hasClass("ie8")) {
                    a.setLogo(!0);
                    var c, d = "css/skins/default-ie8.css";
                    return c = document.createElement("link"), c.rel = "stylesheet", c.href = d, document.getElementsByTagName("head")[0].appendChild(c), !1
                }
                a.options = $.extend({}, a.defaults), String.prototype.capitalize = function() {
        ...
        build: function() {
            var a = this,
                ...
                e = a.container.find(".color-quaternary input");
            b.val(a.options.colorPrimary).parent().colorpicker(), c.val(a.options.colorSecondary).parent().colorpicker(), d.val(a.options.colorTertiary).parent().colorpicker(), e.val(a.options.colorQuaternary).parent().colorpicker(), $(".colorpicker").on("mousedown", function(b) {
            ...
            }), $(".colorpicker-element input").on("blur", function() {
            ...
            }), this.container.find(".options-links.website-type a").click(function(a) {
        ...
        setLayoutStyle: function(a, b) {
            ...
            if (c.options.preserveCookies || $.cookie("layoutStyle", a), b) return $.cookie("showSwitcher", !0), window.location.reload(), !1;
            var d = this.container.find(".options-links.layout"),
                e = this.container.find(".patterns");
            d.find(".active").removeClass("active"), d.find("a[data-layout-type=" + a + "]").addClass("active"), "wide" == a ? (e.hide(), $("html").removeClass("boxed"), $.removeCookie("backgroundPattern")) : (e.show(), $("html").addClass("boxed"), null == $.cookie("backgroundPattern") && this.container.find("ul[data-type=patterns] li:first a").click()), $.event.trigger({
        ...
        setWebsiteType: function(a) {
            ...
            "one-page" == a ? (b.find("a:last").addClass("active"), c.prev().remove(), c.remove()) : b.find("a:first").addClass("active")
        },
        setBackgroundColor: function(a) {
            var b = this;
            b.options.preserveCookies || $.cookie("backgroundColor", a);
            var c = this.container.find(".options-links.background-color");
            c.find(".active").removeClass("active"), c.find("a[data-background-color=" + a + "]").addClass("active"), "dark" == a ? $("html").addClass("dark") : $("html").removeClass("dark"), $.event.trigger({
        ...
        setBackgroundPattern: function(a) {
            var b = this;
            if ("" == a) return this;
            var c = $("html").hasClass("boxed");
            c && $("html").css("background-image", "url(http://refaktorthemes.com/porto/sites/all/themes/Porto/img/patterns/" + a + ".png)"), b.options.preserveCookies || $.cookie("backgroundPattern", a), $.event.trigger({
                type: "styleSwitcher.setBackgroundPattern",
                pattern: a
            })
        },
        setLogo: function(a) {
            return this.options.changeLogo ? (a || ("#" + $.cookie("colorPrimary")).toUpperCase() == this.defaults.colorPrimary.toUpperCase() && "dark" != $.cookie("backgroundColor") ? $("#header .header-logo img").attr("src", "img/logo-default.png") : "dark" == $.cookie("backgroundColor") ? $("#header .header-logo img").attr("src", "img/logo-dark.png") : $("#header .header-logo img").attr("src", "img/logo.png"), void $.event.trigger({
        ...
        reset: function() {
            $.removeCookie("borderRadius"), $.removeCookie("colorPrimary"), $.removeCookie("colorSecondary"), $.removeCookie("colorTertiary"), $.removeCookie("colorQuaternary"), $.removeCookie("layoutStyle"), $.removeCookie("backgroundColor"), $.removeCookie("backgroundPattern"), $.cookie("showSwitcher", !0), window.location.reload()
        },
        getCss: function() {
            raw = "";
            var a = $("html").hasClass("boxed");
            a ? (raw = 'body { background-image: url("../../http://refaktorthemes.com/porto/sites/all/themes/Porto/img/patterns/' + $.cookie("pattern") + '.png"); }', $("#addBoxedClassInfo").show()) : $("#addBoxedClassInfo").hide(), $("#getCSSTextarea").text($('style[id^="less:"]').text()).focus(function() {
                var a = $(this);
