...
var _gizra$municipality$App_Types$Contact = {ctor: 'Contact'};
var _gizra$municipality$App_Types$Hebrew = {ctor: 'Hebrew'};
var _gizra$municipality$App_Types$English = {ctor: 'English'};
var _gizra$municipality$App_Types$Arabic = {ctor: 'Arabic'};

var _gizra$municipality$Contact_Model$emptyModel = {contacts: _Gizra$elm_dictlist$DictList$empty, filterString: ''};
var _gizra$municipality$Contact_Model$Model = F2(
	function (a, b) {
		return {contacts: a, filterString: b};
	});
var _gizra$municipality$Contact_Model$Topic = F3(
	function (a, b, c) {
...
var _gizra$municipality$Contact_Model$Contact = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {name: a, department: b, jobTitle: c, imageUrl: d, topics: e, phone: f, fax: g, email: h, address: i, receptionTimes: j, showEditLink: k};
										};
									};
								};
							};
...
var _gizra$municipality$Contact_Model$SetFilter = function (a) {
...
var _gizra$municipality$Contact_Model$Tertiary = {ctor: 'Tertiary'};
var _gizra$municipality$Contact_Model$Success = {ctor: 'Success'};
...
var _gizra$municipality$Event_Model$emptyModel = {
	event: {
		...
		endDate: _elm_lang$core$Maybe$Nothing,
		recurringWeekly: false,
		ticketPrice: _elm_lang$core$Maybe$Nothing,
		location: _elm_lang$core$Maybe$Nothing,
		showEditLink: false
	}
};
...
var _gizra$municipality$Events_Model$SetFilter = function (a) {
	return {ctor: 'SetFilter', _0: a};
};
var _gizra$municipality$Events_Model$HandleEvents = function (a) {
...
var _gizra$municipality$App_Model$MsgPagesEvents = function (a) {
	return {ctor: 'MsgPagesEvents', _0: a};
};
...
var _gizra$municipality$Utils_Json$decodeEmptyArrayAs = function ($default) {
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		function (list) {
...
var _gizra$municipality$Utils_Json$decodeDateFromEpoch = A2(_elm_lang$core$Json_Decode$map, _elm_lang$core$Date$fromTime, _elm_lang$core$Json_Decode$float);
var _gizra$municipality$Utils_Json$decodeDate = _elm_lang$core$Json_Decode$oneOf(
	{
		ctor: '::',
		_0: _elm_community$json_extra$Json_Decode_Extra$date,
		_1: {
			ctor: '::',
			_0: _gizra$municipality$Utils_Json$decodeDateFromEpoch,
			_1: {ctor: '[]'}
		}
	});

var _gizra$municipality$Contact_Decoder$decodeDay = _elm_lang$core$Json_Decode$list(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (day) {
			var _p0 = day;
			switch (_p0) {
				case '0':
					return _elm_lang$core$Json_Decode$succeed(_elm_lang$core$Date$Sun);
				case '1':
					return _elm_lang$core$Json_Decode$succeed(_elm_lang$core$Date$Mon);
				case '2':
					return _elm_lang$core$Json_Decode$succeed(_elm_lang$core$Date$Tue);
				case '3':
					return _elm_lang$core$Json_Decode$succeed(_elm_lang$core$Date$Wed);
				case '4':
					return _elm_lang$core$Json_Decode$succeed(_elm_lang$core$Date$Thu);
				case '5':
					return _elm_lang$core$Json_Decode$succeed(_elm_lang$core$Date$Fri);
				case '6':
					return _elm_lang$core$Json_Decode$succeed(_elm_lang$core$Date$Sat);
				default:
					return _elm_lang$core$Json_Decode$fail(
						A2(_elm_lang$core$Basics_ops['++'], 'Could not recognise day: ', day));
			}
		},
		_elm_lang$core$Json_Decode$string));
var _gizra$municipality$Contact_Decoder$decodeColor = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (color) {
		var _p1 = color;
		switch (_p1) {
			case 'danger':
				return _elm_lang$core$Json_Decode$succeed(_gizra$municipality$Contact_Model$Danger);
			case 'warning':
				return _elm_lang$core$Json_Decode$succeed(_gizra$municipality$Contact_Model$Warning);
			case 'quaternary':
				return _elm_lang$core$Json_Decode$succeed(_gizra$municipality$Contact_Model$Quaternary);
			case 'success':
				return _elm_lang$core$Json_Decode$succeed(_gizra$municipality$Contact_Model$Success);
			case 'tertiary':
				return _elm_lang$core$Json_Decode$succeed(_gizra$municipality$Contact_Model$Tertiary);
			case 'primary':
				return _elm_lang$core$Json_Decode$succeed(_gizra$municipality$Contact_Model$Primary);
			case 'secondary':
	...
	A3(
		...
		A3(
			...
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'days',
				_gizra$municipality$Contact_Decoder$decodeDay,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_gizra$municipality$Contact_Model$ReceptionTimes)))));
var _gizra$municipality$Contact_Decoder$decodeTopic = _elm_lang$core$Json_Decode$list(
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'color',
		_gizra$municipality$Contact_Decoder$decodeColor,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'name',
			_elm_lang$core$Json_Decode$string,
			A3(
				...
				'id',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_gizra$municipality$Contact_Model$Topic)))));
var _gizra$municipality$Contact_Decoder$decodeContact = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'showEditLink',
	_elm_lang$core$Json_Decode$bool,
	A4(
		...
		'reception_hours',
		_elm_lang$core$Json_Decode$nullable(_gizra$municipality$Contact_Decoder$decodeReceptionTimes),
		_elm_lang$core$Maybe$Nothing,
		A4(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
			'address',
				...
				A4(
					...
					A4(
						...
						A4(
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
							'topics',
							_elm_lang$core$Json_Decode$nullable(_gizra$municipality$Contact_Decoder$decodeTopic),
							_elm_lang$core$Maybe$Nothing,
							A4(
								_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
								'image_url',
...
var _gizra$municipality$Contact_Decoder$decodeContacts = _elm_lang$core$Json_Decode$oneOf(
	{
		...
		_1: {
			ctor: '::',
			_0: _gizra$municipality$Utils_Json$decodeEmptyArrayAs(_Gizra$elm_dictlist$DictList$empty),
			_1: {ctor: '[]'}
		}
	});

var _gizra$municipality$Contact_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
...
var _gizra$municipality$Events_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
...
var _gizra$municipality$App_Update$subscriptions = function (model) {
	...
	switch (_p0.ctor) {
		case 'Contact':
			return A2(_elm_lang$core$Platform_Sub$map, _gizra$municipality$App_Model$MsgPagesContact, _gizra$municipality$Contact_Update$subscriptions);
		case 'Event':
			return A2(_elm_lang$core$Platform_Sub$map, _gizra$municipality$App_Model$MsgPagesEvent, _gizra$municipality$Event_Update$subscriptions);
		case 'Events':
			return A2(_elm_lang$core$Platform_Sub$map, _gizra$municipality$App_Model$MsgPagesEvents, _gizra$municipality$Events_Update$subscriptions);
		default:
			return _elm_lang$core$Platform_Sub$none;
	}
};
var _gizra$municipality$App_Update$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'MsgPagesContact':
...
var _gizra$municipality$App_Update$init = function (flags) {
	var language = function () {
		var _p5 = flags.language;
		switch (_p5) {
			case 'ar':
				return _gizra$municipality$App_Types$Arabic;
			case 'en':
				return _gizra$municipality$App_Types$English;
			case 'he':
				return _gizra$municipality$App_Types$Hebrew;
			default:
				return _gizra$municipality$App_Types$English;
		}
	}();
	var page = function () {
		...
		switch (_p6) {
			...
			case 'events':
				return _gizra$municipality$App_Types$Events;
			default:
...
var _gizra$municipality$Contact_Utils$filterContacts = F2(
...
var _gizra$municipality$Utils_BootstrapGrid$renderColumn = F2(
	function (columnClass, column) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(columnClass),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _gizra$municipality$Utils_BootstrapGrid$renderRow = F2(
	function (columnClass, row) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
			...
			A2(
				_elm_lang$core$List$map,
				_gizra$municipality$Utils_BootstrapGrid$renderColumn(columnClass),
				row));
	});
...
var _gizra$municipality$Utils_BootstrapGrid$renderBootstrapGrid = F2(
	function (columnsInOneRow, colHtmlMsgList) {
		...
		return A2(
			...
			A2(
				_elm_lang$core$List$map,
				_gizra$municipality$Utils_BootstrapGrid$renderRow(columnClass),
				listOfRows));
	});

var _gizra$municipality$Utils_Html$editLinkElement = F3(
	function (baseUrl, language, itemId) {
		return A2(
		...
		if (multipleDays) {
			...
			return A2(
				...
				A2(
					_gizra$municipality$Translate$translate,
					language,
					_gizra$municipality$Translate$DayTranslation(firstDay)),
				A2(
					_elm_lang$core$Basics_ops['++'],
					' - ',
					A2(
						...
						A2(
							_gizra$municipality$Translate$translate,
							language,
							_gizra$municipality$Translate$DayTranslation(lastDay)),
						', ')));
		} else {
			return A2(
				_elm_lang$core$Basics_ops['++'],
...
var _gizra$municipality$Utils_Html$sectionDivider = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('section divider'),
		_1: {ctor: '[]'}
	},
	{ctor: '[]'});
var _gizra$municipality$Utils_Html$divider = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
...
var _gizra$municipality$Utils_Html$showIf = F2(
	function (condition, html) {
		return condition ? html : _gizra$municipality$Utils_Html$emptyNode;
	});
var _gizra$municipality$Utils_Html$showMaybe = _elm_lang$core$Maybe$withDefault(_gizra$municipality$Utils_Html$emptyNode);

var _gizra$municipality$Contact_View$viewContactAsBlock = F3(
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					_p4.showEditLink,
					A3(_gizra$municipality$Utils_Html$editLinkElement, baseUrl, language, _p1._0)),
				_1: {
					ctor: '::',
																...
																return A2(
																	...
																	{ctor: '[]'},
																	{
																		...
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$class('fa fa-fax'),
																				_1: {ctor: '[]'}
																			},
																			{ctor: '[]'}),
																		_1: {
																		...
																		A2(
																			...
																			function (_p2) {
																				...
																				return A2(
																					...
																					{
																						ctor: '::',
																						_0: _elm_lang$html$Html_Attributes$class('mr-xs'),
																						_1: {ctor: '[]'}
																					},
																					{
																						ctor: '::',
...
var _gizra$municipality$Contact_View$viewContact = F3(
	function (baseUrl, language, _p5) {
		var _p6 = _p5;
		var _p9 = _p6._1;
		return A2(
			_elm_lang$html$Html$div,
			...
			},
			{
				...
				_0: A2(
					_gizra$municipality$Utils_Html$showIf,
					_p9.showEditLink,
					A3(_gizra$municipality$Utils_Html$editLinkElement, baseUrl, language, _p6._0)),
				_1: {
					ctor: '::',
					_0: _gizra$municipality$Utils_Html$showMaybe(
						A2(
										...
										_0: A2(
											_elm_lang$html$Html$img,
											{
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$alt(_p9.name),
														_1: {ctor: '[]'}
													}
												}
											},
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('caption center'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											ctor: '::',
											_0: _gizra$municipality$Utils_Html$showMaybe(
												A2(_elm_lang$core$Maybe$map, _elm_lang$html$Html$text, _p9.department)),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{ctor: '[]'},
											{
												ctor: '::',
												_0: _gizra$municipality$Utils_Html$showMaybe(
													A2(_elm_lang$core$Maybe$map, _elm_lang$html$Html$text, _p9.jobTitle)),
												_1: {
													ctor: '::',
															...
															A2(
																...
																function (topics) {
																	return A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$class('labels topic-wrapper'),
																			_1: {ctor: '[]'}
																		},
																		A2(
																			_elm_lang$core$List$map,
																			function (topic) {
																				return A2(
																					_elm_lang$html$Html$a,
																					{
																						...
																						_1: {
																							ctor: '::',
																							_0: _elm_lang$html$Html_Attributes$title(topic.name),
																							_1: {ctor: '[]'}
																						}
																					},
																					{
														...
														_1: {
															...
															_1: {
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$class('contact-details center'),
																		_1: {ctor: '[]'}
																	},
																	{
																		ctor: '::',
																												...
																												function (receptionTimes) {
																													return A2(
																														...
																														},
																														{
																															ctor: '::',
																															_0: _elm_lang$html$Html$text(
																																A2(_gizra$municipality$Translate$translate, language, _gizra$municipality$Translate$ReceptionText)),
																															_1: {
																																ctor: '::',
																																_0: A2(
																																	_elm_lang$html$Html$span,
																																					...
																																					_1: {
																																						...
																																						_0: A2(
																																							...
																																							},
																																							{
																																								ctor: '::',
																																								_0: _elm_lang$html$Html$text(
																																									A3(_gizra$municipality$Utils_Html$formatReceptionDays, language, _p8.days, _p8.multipleDays)),
																																								_1: {ctor: '[]'}
																																							}),
																																						_1: {
																																							ctor: '::',
																																							_0: A2(
																																								...
																																								{
																																									ctor: '::',
																																									_0: _elm_lang$html$Html$text(_p8.hours),
																																									_1: {ctor: '[]'}
																																								}),
																																							_1: {ctor: '[]'}
																																						}
...
var _gizra$municipality$Contact_View$viewContacts = F4(
	function (baseUrl, language, showAsBlock, _p10) {
		var _p11 = _p10;
		var filteredContacts = A2(_gizra$municipality$Contact_Utils$filterContacts, _p11.contacts, _p11.filterString);
		if (_Gizra$elm_dictlist$DictList$isEmpty(filteredContacts)) {
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				{
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('col-sm-4 col-sm-push-4 col-sm-pull-4 col-xs-12'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
							...
							},
							{
								...
								_0: A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$id('search-contacts'),
											_1: {
												ctor: '::',
												...
												_1: {
													...
													_1: {
														...
														_0: _elm_lang$html$Html_Attributes$placeholder(
															A2(_gizra$municipality$Translate$translate, language, _gizra$municipality$Translate$FilterContactsPlaceholder)),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onInput(_gizra$municipality$Contact_Model$SetFilter),
															_1: {ctor: '[]'}
														}
													}
												}
...
var _gizra$municipality$Contact_View$viewContactsHeader = function (language) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
				...
				},
				{
					...
					_0: A2(
						...
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								A2(_gizra$municipality$Translate$translate, language, _gizra$municipality$Translate$ContactsHeaderText)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					_gizra$municipality$Utils_Html$showIf,
					!showAsBlock,
					_gizra$municipality$Contact_View$viewContactsHeader(language)),
				_1: {
					ctor: '::',
					_0: A2(
						_gizra$municipality$Utils_Html$showIf,
						!showAsBlock,
						A2(_gizra$municipality$Contact_View$viewContactFilter, language, model.filterString)),
					_1: {
						ctor: '::',
						_0: A2(
							_gizra$municipality$Utils_Html$showIf,
			...
			},
			{
							...
							},
							{
								...
								_0: A2(
									...
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											A2(_gizra$municipality$Translate$translate, language, _gizra$municipality$Translate$EventsHeaderText)),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('row panel panel-default'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('heading heading-primary heading-border heading-bottom-border'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('heading-primary'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
									...
									},
									{
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('row panel-body text-center'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
																				...
																				_0: A2(
																					_elm_lang$html$Html$img,
																					{
																						...
																						_1: {
																							...
																							_1: {
																								ctor: '::',
																								_0: _elm_lang$html$Html_Attributes$alt(event.name),
																								_1: {ctor: '[]'}
																							}
																						}
																					},
...
var _gizra$municipality$Events_Utils$filterEvents = F2(
...
var _gizra$municipality$Events_View$viewEvent = F4(
	function (baseUrl, language, _p0, showAsBlock) {
		...
		var _p5 = _p1._0;
		var _p4 = _p1._1;
		var titleElement = showAsBlock ? A2(
			_elm_lang$html$Html$a,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$href(
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					_gizra$municipality$Utils_Html$showIf,
					_p4.showEditLink,
					A3(_gizra$municipality$Utils_Html$editLinkElement, baseUrl, language, _p5)),
				_1: {
					ctor: '::',
					_0: _gizra$municipality$Utils_Html$showMaybe(
						A2(
										...
										_1: {
											...
											_0: A2(
												...
												},
												{
													...
													_1: {
														ctor: '::',
														_0: A4(_gizra$municipality$Utils_Html$eventDateElement, language, _p4.date, _p4.endDate, _p4.recurringWeekly),
														_1: {ctor: '[]'}
													}
												}),
											_1: {
...
var _gizra$municipality$Events_View$viewEvents = F4(
	function (baseUrl, language, showAsBlock, _p6) {
		var _p7 = _p6;
		var filteredEvents = A2(_gizra$municipality$Events_Utils$filterEvents, _p7.events, _p7.filterString);
		if (_Gizra$elm_dictlist$DictList$isEmpty(filteredEvents)) {
			return A2(
				...
				{ctor: '[]'},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						A2(_gizra$municipality$Translate$translate, language, _gizra$municipality$Translate$EventsNotFound)),
					_1: {ctor: '[]'}
				});
		} else {
					...
					A2(
						...
						F2(
							function (eventId, event) {
								return A4(
									_gizra$municipality$Events_View$viewEvent,
									baseUrl,
									language,
											...
											_1: {
												...
												_1: {
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onInput(_gizra$municipality$Events_Model$SetFilter),
															_1: {ctor: '[]'}
														}
													}
												}
...
var _gizra$municipality$Events_View$viewEventsHeader = function (language) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					_gizra$municipality$Utils_Html$showIf,
					!showAsBlock,
					_gizra$municipality$Events_View$viewEventsHeader(language)),
				_1: {
					ctor: '::',
					_0: A2(
						_gizra$municipality$Utils_Html$showIf,
						!showAsBlock,
						A2(_gizra$municipality$Events_View$viewEventFilter, language, model.filterString)),
					_1: {
						ctor: '::',
						_0: A2(
							_gizra$municipality$Utils_Html$showIf,
...
var _gizra$municipality$Main$main = _elm_lang$html$Html$programWithFlags(
	{init: _gizra$municipality$App_Update$init, update: _gizra$municipality$App_Update$update, view: _gizra$municipality$App_View$view, subscriptions: _gizra$municipality$App_Update$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (baseUrl) {
			return A2(
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _gizra$municipality$Main$main !== 'undefined') {
    _gizra$municipality$Main$main(Elm['Main'], 'Main', undefined);
}
